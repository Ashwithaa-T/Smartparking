      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto mb-12 leading-relaxed">
            Real-time parking slot prediction across India. Find available parking instantly, 
            save time, and make smarter decisions with AI-powered predictions.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="group bg-white/80 backdrop-blur-lg p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 border-2 border-purple-200 hover:border-purple-400 transform hover:scale-105 hover:-rotate-1">
            ...
            <p className="text-gray-600 leading-relaxed">
              Live slot availability powered by ML predictions and real-time data processing
            </p>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-teal-50 to-blue-50 pt-24 px-6 pb-12">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg font-medium mb-3">Real-time parking status across all locations</p>
        ...
        <div className="space-y-8">
          <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border-2 border-orange-300">
            ...
            <p className="text-gray-700 leading-relaxed font-medium">
              ...
              and real-time data analysis, we provide accurate predictions of parking slot availability 
          ...
          <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border-2 border-purple-300">
            ...
            <ul className="space-y-2 text-gray-700">
              ...
              <li className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                <span className="font-medium">Real-time occupancy status for each individual slot</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
...
const HowItWorksPage = () => {
  const steps = [
    ...
    },
    {
      ...
      description: "Our ML-powered system evaluates each individual parking slot in real-time, providing accurate status for every single slot.",
        ...
        <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-10 shadow-2xl border-2 border-purple-300">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center transform hover:scale-110 transition-transform">
              ...
              <h3 className="text-xl font-black text-gray-800 mb-3">Real-Time Analytics</h3>
              <p className="text-gray-700 font-medium">
                Instant processing of slot availability across thousands of parking spaces
              </p>
            </div>
            <div className="text-center transform hover:scale-110 transition-transform">
